...
public class Ex06_Array {
	public static void main(String[] args) {
		...
		System.out.println(score.length); // 3 : 행의 개수
		System.out.println(score[0].length); // 2 : 0행의 열의 개수
		...
		// Today's Point (Array(정적 : 고정) >> Collection(동적))
		// 개선된 for문
		// C# : for (Type변수명 in 배열) { 출력 구문 }
		// Java : for (Type변수명 : 배열) { 출력 구문 }
		// JavaScript = C#
